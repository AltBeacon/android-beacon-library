...
public class ArmaRssiFilter implements RssiFilter {
    ...
    private static int DEFAULT_ARMA_MEASUREMENT = -75;  //What is the typical RSSI that beacons are sending with?
    ...
    private int armaMeasurement = -75;
    private double armaSpeed = 0.1;

    public ArmaRssiFilter() {
        this.armaMeasurement = DEFAULT_ARMA_MEASUREMENT;
    ...
    public static void setDEFAULT_ARMA_MEASUREMENT(int default_arma_measurement) {
        DEFAULT_ARMA_MEASUREMENT = default_arma_measurement;
    }
