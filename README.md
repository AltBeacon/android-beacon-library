...
Networks provides a free [Linux virtual machine](https://github.com/RadiusNetworks/android-ibeacon-service/wiki/Virtual-iBeacon) that when paired with a cheap Bluetooth LE dongle, acts as an iBeacon.   
